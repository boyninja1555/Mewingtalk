...
export function redirectSignIn(router: AppRouterInstance, {
    redirectBack,
    redirectSuccess,
    redirectFailiure,
}: {
...
export default function SignInCard({
    ...
    async function handleSubmit() {
        ...
        const response = await signIn.email(formValues)
            ...
            <CardHeader>
                ...
                <CardDescription className="flex justify-between">
                    <span>
                        {showSignUpLink ? (
                            <>
                                Sign in to Mewingtalk, or <Link href="/sign-up">sign up</Link>.
                            </>
                        ) : (
                            <>
                                Sign in to Mewingtalk.
                            </>
                        )}
                    </span>
